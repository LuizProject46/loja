    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card">
                ...
                <h1 class="card-title mt-5">Editar Produto</h1>
                <?=$msg?>
                <form enctype="multipart/form-data" method="POST">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Titulo</label>
                        <input required type="text" name="name" class="form-control" value="<?=$produto[name]?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                        
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1"> Preço</label>
                        <input required type="text" name="price" class="form-control" value="<?=$produto[price]?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Descrição</label>
                        <textarea name="description" required class="form-control"  id="exampleFormControlTextarea1" rows="3"><?=$produto[description]?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="upload-btn-wrapper">
                            ...
                            <br/>
                            <br/>
                            <img style="" id="blah" src="<?=$site[url]?>uploads/<?=$produto[image]?>" alt="image" width="120" height="120" />
                        </div>
                    </div>
                    
                    <input type="submit" class=" btn btn-info col-md-12 mt-5" value="Salvar Alterações"/>
                </form>
